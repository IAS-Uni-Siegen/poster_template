...
\footercontent{
  \href{https://www.eti.uni-siegen.de/ias/}{https://www.eti.uni-siegen.de/ias/} \hfill
...
% \logoright{\includegraphics[height=4cm]{assets/UNIS-Dachmarke_kurz_rgb_unis_dachmarke.svg}}
\logoleft{\includegraphics[height=7cm]{assets/UNIS-Dachmarke_cmyk.pdf}}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Simulation framework}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.7\textwidth]{figures/simulation_structure.pdf}
      ...
      %   \begin{figure}[htb]
      %     \centering
      %     \includegraphics[width=0.7\textwidth]{figures/fluxLinkage.pdf}
      ...
      \begin{block}{Differential inductances}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.65\textwidth]{figures/diffInductances.pdf}
      ...
      \begin{block}{Modulation index}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.65\textwidth]{figures/modulation_index.pdf}
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Pulse pattern}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.7\textwidth]{figures/OPP_lin_nonlin.pdf}
      ...
      \begin{block}{Stator current}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.7\textwidth]{figures/i_ab_cross_check.pdf}
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Switching angles}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.65\textwidth]{figures/sw_angles.pdf}
      ...
      %   \begin{figure}[htb]
      %     \centering
      %     \includegraphics[width=0.7\textwidth]{figures/losses.pdf}
      ...
      \begin{block}{Multi-objective optimization}
        \begin{figure}[htb]
          \centering
          \includegraphics[width=0.65\textwidth]{figures/paretoFront.pdf}
      ...
      %   \begin{figure}[htb]
      %     \centering
      %     \includegraphics[width=0.7\textwidth]{figures/OPP7_PWM7.pdf}
      ...
      \begin{block}{Contact}
        \begin{figure}[ht]
          ...
          \begin{minipage}{0.15\textwidth}
            \fancyqr[image = {\includegraphics[width=1.1cm]{assets/UNIS-Dachmarke_kurz_PAT.pdf}}, image padding=1, height=4cm, color=unidarkblue, level=H]{https://www.eti.uni-siegen.de/ias/}
          \end{minipage}%
